...
<a class="bg-safety-emerald hover:bg-safety-emerald-bright text-text-primary font-headline-sm text-credential-meta uppercase px-6 py-3 transition-colors flex items-center gap-2" href="https://wa.me/{{ config('contact.whatsapp') }}?text=Halo%20TrainingKota%20Malang%20saya%20ingin%20konsultasi%20layanan%20K3" target="_blank">
...
<a class="bg-safety-emerald hover:bg-safety-emerald-bright text-text-primary font-credential-meta text-credential-meta uppercase px-3 py-2" href="https://wa.me/{{ config('contact.whatsapp') }}?text=Daftar%20AK3U%20Malang">
              Daftar Batch
            </a>
</div>
</div>
...
<a class="bg-safety-emerald hover:bg-safety-emerald-bright text-text-primary font-credential-meta text-credential-meta uppercase px-3 py-2" href="https://wa.me/{{ config('contact.whatsapp') }}?text=Daftar%20Operator%20Forklift%20Malang">
              Daftar Batch
            </a>
</div>
</div>
...
<a class="bg-safety-emerald hover:bg-safety-emerald-bright text-text-primary font-credential-meta text-credential-meta uppercase px-3 py-2" href="https://wa.me/{{ config('contact.whatsapp') }}?text=Pengurusan%20SLF%20Malang">
              Ajukan Audit
            </a>
</div>
</div>
...
<a class="bg-safety-emerald hover:bg-safety-emerald-bright text-text-primary font-credential-meta text-credential-meta uppercase px-3 py-2" href="https://wa.me/{{ config('contact.whatsapp') }}?text=Daftar%20P3K%20Malang">
              Daftar Batch
            </a>
</div>
</div>
...
<a class="bg-safety-emerald hover:bg-safety-emerald-bright text-text-primary font-credential-meta text-credential-meta uppercase px-3 py-2" href="https://wa.me/{{ config('contact.whatsapp') }}?text=Kajian%20Fire%20Risk%20Malang">
              Konsultasi
            </a>
</div>
</div>
...
<a class="bg-safety-emerald hover:bg-safety-emerald-bright text-text-primary font-credential-meta text-credential-meta uppercase px-3 py-2" href="https://wa.me/{{ config('contact.whatsapp') }}?text=Daftar%20Operator%20Boiler%20Malang">
              Daftar Batch
            </a>
</div>
</div>
...
<td class="p-3 text-right">
    <a class="bg-regulatory-slate-700 hover:bg-safety-emerald text-text-primary px-3 py-1 font-credential-meta text-credential-meta uppercase transition-colors inline-block font-bold" href="https://wa.me/{{ config('contact.whatsapp') }}?text={{ urlencode('Halo, saya ingin booking kuota ' . $svc->name . ' di ' . $city->name) }}" target="_blank">
        Ambil Kuota
    </a>
</td>
</tr>
        ...
        <div class="space-y-3 bg-regulatory-slate-900 p-4">
            ...
            <div class="flex items-start gap-3">
                ...
                <div>
                    ...
                    <span class="font-body-sm text-body-sm text-safety-emerald-bright block font-bold">{{ config('contact.display') }} (WhatsApp Direct 24 Jam)</span>
                </div>
            </div>
        </div>
    </div>
    <div class="pt-6 flex flex-wrap items-center gap-3">
        <a class="bg-safety-emerald hover:bg-safety-emerald-bright text-text-primary font-credential-meta text-credential-meta uppercase px-4 py-2.5 transition-colors flex items-center gap-2 font-bold" href="https://wa.me/{{ config('contact.whatsapp') }}?text={{ urlencode('Halo Admin, saya ingin konsultasi layanan di ' . $city->name) }}" target="_blank">
...
<a class="w-full sm:w-auto text-center bg-safety-emerald hover:bg-safety-emerald-bright text-text-primary font-credential-meta text-credential-meta uppercase px-6 py-3 transition-colors" href="https://wa.me/{{ config('contact.whatsapp') }}?text=Halo%20TrainingKota%20Malang%20saya%20minta%20SPH%20dan%20Silabus" target="_blank">
